...
const ProductsDetails = () => {
    ...
    return product && (
        <div className="mt-16">
            <p>
                <Link to={'/'}>Home</Link> /
                <Link to={'/meals'}> Products</Link> /
                <Link to={`/meals/${product.category.toLowerCase()}`}> {product.category}</Link> /
            ...
            <div className='mt-20 flex flex-col items-center'>
                <div className='flex flex-col items-center w-max'>
                    <p className='text-3xl font-medium'>Related Meals</p>
                ...
                <button onClick={() => { navigate('/meals'); scrollTo(0, 0) }} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition">
                    Explore more
                </button>
            </div>
        </div>
