...
import banner_bg_logo from "./banner_bg_image.jpg";
import north_indian_image from "./north_indian_thali.png";
import south_indian_image from "./south_indian_thali.png";
import veg_combo_image from "./veg_combo_meal.png";
...
export const categories = [
  {
    text: "North Indian Meals",
    path: "North Indian Meals",
    image: north_indian_image,
    bgColor: "#FEF6DA",
  },
  {
    text: "South Indian Meals",
    path: "South Indian Meals",
    image: south_indian_image,
    bgColor: "#FEE0E0",
  },
  {
    text: "Veg Combo Meals",
    path: "Veg Combo Meals",
    image: veg_combo_image,
    bgColor: "#F0F5DE",
  },
  {
    text: "Non-Veg Meals",
  ...
  {
    text: "Healthy Diet Tiffin",
    path: "Healthy Diet Tiffin",
    image: healthy_diet_image,
    bgColor: "#FEE6CD",
  },
  {
    text: "Office Lunch Box",
    path: "Office Lunch Box",
    image: office_lunch_image,
    bgColor: "#E0F6FE",
  },
  {
...
export const dummyProducts = [
  ...
  // Dairy
  {
    _id: "ek56j67k",
    name: "Amul Milk 1L",
    category: "Veg Combo MNon Veg Meals",
    price: 60,
    offerPrice: 55,
  ...
  // Instant
  {
    ...
    category: "Weekend Special Thali",
